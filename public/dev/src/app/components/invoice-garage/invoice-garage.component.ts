...
@Component({
    selector: 'app-invoice-garage',
    templateUrl: './invoice-garage.component.html',
    styles: []
})
export class InvoiceGarageComponent implements OnInit
    , ICommon, ICrud, IDatePicker, ISearch {

    /** ===== MY VARIABLES ===== **/
    public invoice_garages: any[] = [];
    public invoice_garage: any;
    ...
    ngOnInit(): void {
        ...
        this.prefix_url = 'invoice_garages';
    ...
    loadOne(id: number): void {
        this.invoice_garage = this.invoice_garages.find(o => o.id == id);
    }
    ...
    addOne(): void {
        ...
        this.httpClientService.post(this.prefix_url, {"invoice_garage": this.invoice_garage}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
    ...
    updateOne(): void {
        ...
        this.httpClientService.put(this.prefix_url, {"invoice_garage": this.invoice_garage}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
    ...
    reloadDataSearch(arr_data: any[]): void {
        this.invoice_garages = arr_data['invoice_garages'];
    }
