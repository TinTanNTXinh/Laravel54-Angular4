...
export class PositionComponent implements OnInit
    ...
    loadOne(id: number): void {
        this.position = this.positions.find(o => o.id == id);
    }
    ...
    addOne(): void {
        ...
        this.httpClientService.post(this.prefix_url, {"position": this.position}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
    ...
    updateOne(): void {
        ...
        this.httpClientService.put(this.prefix_url, {"position": this.position}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
