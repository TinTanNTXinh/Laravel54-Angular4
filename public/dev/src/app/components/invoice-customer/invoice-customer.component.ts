...
export class InvoiceCustomerComponent implements OnInit
    ...
    loadOne(id: number): void {
        this.invoice_customer = this.invoice_customers.find(o => o.id == id);
    }
    ...
    addOne(): void {
        ...
        this.httpClientService.post(this.prefix_url, {"invoice_customer": this.invoice_customer}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
    ...
    updateOne(): void {
        ...
        this.httpClientService.put(this.prefix_url, {"invoice_customer": this.invoice_customer}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
